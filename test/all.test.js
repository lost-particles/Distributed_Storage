...
test('(0 pts) all.mem.get(jcarb)', (done) => {
...
test('(0 pts) all.mem.del(jcarb)', (done) => {
...
test('(0 pts) all.mem.put(jcarb)', (done) => {
...
test('(0 pts) all.mem.put/get(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpg';
...
test('(0 pts) all.mem.put/del(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpd';
...
test('(0 pts) all.mem.put/del/get(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpdg';
...
test('(0 pts) all.mem.put(jcarb)/mygroup.mem.get(jcarb)', (done) => {
...
test('(0 pts) all.mem.put(no key)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
...
test('(0 pts) all.mem.get(no key)', (done) => {
  const users = [
...
test('(0 pts) all.store.get(jcarb)', (done) => {
...
test('(0 pts) all.store.del(jcarb)', (done) => {
...
test('(0 pts) all.store.put(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmp';
...
test('(0 pts) all.store.put/get(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpg';
...
test('(0 pts) all.store.put/del(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpd';
...
test('(0 pts) all.store.put/del/get(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbmpdg';
...
test('(0 pts) all.store.put(jcarb)/mygroup.store.get(jcarb)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
  const key = 'jcarbspsg';
...
test('(0 pts) all.store.put(no key)', (done) => {
  const user = {first: 'Josiah', last: 'Carberry'};
...
test('(0 pts) all.store.get(no key)', (done) => {
  const users = [
    {first: 'Emma', last: 'Watson'},
    {first: 'John', last: 'Krasinski'},
    {first: 'Julie', last: 'Bowen'},
